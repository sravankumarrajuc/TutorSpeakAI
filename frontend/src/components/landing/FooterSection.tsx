        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">TutorSpeakAI</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Revolutionizing education with voice-first AI tutoring. Transform any document 
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">Get the latest news, updates, and tips delivered to your inbox.</p>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} TutorSpeakAI. All rights reserved.
            </div>
