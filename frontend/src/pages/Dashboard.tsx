  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Introduction to React</p>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Advanced JavaScript</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">AI Companions</h3>
          <div className="space-y-3">
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="ml-3">
                <p className="font-medium text-gray-900">JavaScript Tutor</p>
                <p className="text-sm text-gray-600">Specializes in web development</p>
              </div>
            </div>
            <div className="flex items-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="ml-3">
                <p className="font-medium text-gray-900">Python Assistant</p>
                <p className="text-sm text-gray-600">Data science and algorithms</p>
              </div>
            </div>
          </div>
        </div>
